...
> **⚠️ Important**: Make sure you are in the `frontend` folder before running any commands.
...
<ol>
    ...
    <li>Start dev server: <code>npm run start</code>. A browser window will open on http://localhost:3000 where you'll see the live preview</li>
</ol>
